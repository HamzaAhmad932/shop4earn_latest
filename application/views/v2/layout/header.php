            ...
            <div class="header-top">
                <div class="container">
                    ...
                    <div class="header-right">
                        <p class="welcome-msg"><!-- welcome message here --></p>
            ...
            <div class="header-middle">
                <div class="container">
                    <div class="header-left">
                        <a href="/" class="logo">
                            <img src="<?php echo base_url('v2/assets/images/shop4earn_logo.png')?>" alt="Porto Logo">
                        </a>
                    </div><!-- End .header-left -->
                    ...
                    <div class="header-right">
                        ...
                        <div class="header-contact">
                            ...
                            <a href="tel:#"><strong>+9230098762345</strong></a>
